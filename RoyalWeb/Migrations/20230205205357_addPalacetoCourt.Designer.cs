...
namespace RoyalWeb.Migrations
{
    ...
    [Migration("20230205205357_addPalacetoCourt")]
    partial class addPalacetoCourt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoyalWeb.Models.Opinion", b =>
                {
                    ...
                    b.Property<int>("OpinionOfCharacterId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OpinionOfCharacterId");
            ...
            modelBuilder.Entity("RoyalWeb.Models.Opinion", b =>
                {
                    b.HasOne("RoyalWeb.Models.Character", "OpinionOf")
                        .WithMany("Opinions")
                        .HasForeignKey("OpinionOfCharacterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("OpinionOf");
                });
